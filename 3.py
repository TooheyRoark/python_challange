...
pat = '011101110' #this is exactly the pattern I'm looking for

start = 0
word = ''

while start !=8:
    if binary_mess.find(pat,start) + len(pat) == 8:
        break
    word += mess[binary_mess.find(pat,start)+4:binary_mess.find(pat,start)+5]
    start = binary_mess.find(pat,start) + len(pat)
print word
